...
urlpatterns = [
    ...
    path('event/<int:event_id>/', EventDetailAPIView.as_view(), name='event-detail'),
    path('event/<int:event_id>/add_member/', EventMemberCreateAPIView.as_view(), name='event-add-member'),
